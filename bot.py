        ...
        if usr_cmd == "/start":
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/xplay_main"),
                            InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/xplay_discussion")
                        ],
                        [
                        ...
                        [
                            InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ᴛᴜᴛᴏʀɪᴀʟ ✧✧⎠⎠", url="https://youtu.be/Rtjyz3tlEZwE")
                        ]]))
            else :
                await cmd.reply_photo(photo=lazy_pic,
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ᴛᴜᴛᴏʀɪᴀʟ ✧✧⎠⎠", url="https://youtu.be/Rttjyz3lEZwE")
                        ]]))
    ...
    async def main(bot: Client, message: Message):
        ...
        if message.chat.type == enums.ChatType.PRIVATE:
            ...
            try:
                ...
                share_link = f"https://t.me/{Config.BOT_USERNAME}?start=webdev_{str_to_b64(file_er_id)}"
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/xplay_main"),
                            InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/xplay_discussion")
                        ],
                        [
                            InlineKeyboardButton("🤖Aß⊕ut ß⊕t", callback_data="aboutbot"),
                            InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="aboutdevs")
                        ...
                        [
                            InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ᴛᴜᴛᴏʀɪᴀʟ ✧✧⎠⎠", url="https://youtu.be/Rtjtyz3lEZwE")
                        ]
                    ]
                )
            )
            ...
            if Config.UPDATES_CHANNEL:
                ...
                try:
                    ...
                    if user.status == "kicked":
                        await cmd.message.edit(
                            text="ꜱᴏʀʀʏ ꜱɪʀ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ᴛᴏ ᴜꜱᴇ ᴍᴇ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/xplay_main).",
                            disable_web_page_preview=True
                        )
                        return
                    ...
                    await cmd.message.edit(
                        text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/xplay_main).",
                        disable_web_page_preview=True
                    )
                    return
            if(Config.LAZY_MODE == True):
